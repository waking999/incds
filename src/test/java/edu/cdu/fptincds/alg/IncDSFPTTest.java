...
public class IncDSFPTTest {
	...
	public void testComputing_400() {
		...
		// 2. take advanteage of fptincds to generate dominating set of graph 2,
		// which is obtained from graph 1 via operations
		...
		List<Integer> ds2Ds1Diff = (List<Integer>) CollectionUtils.subtract(
				ds2, ds1);
		sb.setLength(0);
		sb.append("Difference between the dominating set for g2 by incdsfpt and for g1 by greedy("
				+ ds2Ds1Diff.size() + "):");
		...
		List<Integer> ds3Ds1Diff = (List<Integer>) CollectionUtils.subtract(
				ds3, ds1);
		sb.setLength(0);
		sb.append("Difference between ds solution of g1 and g2("
				+ ds3Ds1Diff.size() + "):");
		...
		List<Integer> ds3Ds2Diff = (List<Integer>) CollectionUtils.subtract(
				ds3, ds2);
		sb.setLength(0);
		sb.append("Difference between ds solution for g2 by fptincds and for g2 by greedy("
				+ ds3Ds2Diff.size() + "):");
	...
	public void testComputing_600() {
		log.debug("IncDSFPTTest testcase600");
		// 1. take advantage of greedy to generate dominating set of graph 1;
		FileInfo fileInfo1 = new FileInfo();
		fileInfo1.setInputFile("src/test/resources/20140511_testcase600_a.csv");
		...
		// which is obtained from graph 1 via operations
		FileInfo fileInfo2 = new FileInfo();
		fileInfo2.setInputFile("src/test/resources/20140511_testcase600_b.csv");
		...
		List<Integer> ds3Ds1Diff = (List<Integer>) CollectionUtils.subtract(
				ds3, ds1);
		sb.setLength(0);
		sb.append("Difference between ds solution for g1 by greedy and for g2 by greedy("
				+ ds3Ds1Diff.size() + "):");
		for (Integer i : ds3Ds1Diff) {
			sb.append(i).append(" ");
		}
