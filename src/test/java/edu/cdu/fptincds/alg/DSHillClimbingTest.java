...
public class DSHillClimbingTest {
	private Logger log = LogUtil.getLogger(DSHillClimbingTest.class);
	...
	private List<Integer> testComputingWithDifferentData(String message, String inputFile) {
		log.debug(message);
		...
		log.debug("number of Vertices in dominating set:"+ds2.size());
